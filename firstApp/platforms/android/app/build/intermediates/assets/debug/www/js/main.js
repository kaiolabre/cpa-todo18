...
taskform.addEventListener('submit', function (event) {
    ...
    if (taskname.length > 0) {
        ...
        function onSuccess(imageURI) {
            ...
            var task = new task_1.Task(image.src);
            taskmanager.add(task);
            taskstorage.store(taskarray, function (result) {
                if (result) {
                    taskform.reset();
